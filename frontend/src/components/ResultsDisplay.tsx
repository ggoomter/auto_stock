...
import { TrendingUp, TrendingDown, BarChart3, AlertCircle, Activity, ChevronDown, ChevronUp, ShieldCheck, ShieldAlert } from 'lucide-react';
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      {(() => {
        ...
        return (
          <div className={`rounded-xl border-2 ${config.border} bg-gradient-to-r ${config.bg} p-4`}>
